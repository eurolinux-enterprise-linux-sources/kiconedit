...
class DrawCommand : public K3Command {
    public:
...
class RepaintCommand : public K3Command {
    public:
...
class KGridView : public QFrame
{
    Q_OBJECT
public:
  KGridView( QImage *image, K3CommandHistory* history, QWidget * parent = 0, const char *name = 0);
  ...
  Q3ScrollView *viewPortWidget() { return viewport;}
...
class KIconEditGrid : public KColorGrid
{
    Q_OBJECT
public:
  KIconEditGrid( QImage *image, K3CommandHistory* h, QWidget * parent = 0);
...
protected:
  ...
  void createCursors();
  void drawPointArray(Q3PointArray, DrawAction);
